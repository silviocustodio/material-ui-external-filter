  ...
  render() {
    ...
    return (
      <Drawer openSecondary={true} open={isOpen} width={this.props.width}>
        <AppBar
          title={formatMessage ? formatMessage({ id: 'filter' }) : 'Filtros'}
          onLeftIconButtonTouchTap={this.handleCloseFilter}
          iconElementLeft={
            <IconButton
              tooltipPosition={'bottom-right'}
              tooltip={formatMessage ? formatMessage({ id: 'close_filter' }) : 'Fechar filtro'}>
        ...
        <div>
          <div style={{ display: 'flex', flexDirectiaron: 'row', alignItems: 'center' }}>
            <Subheader >{formatMessage ? formatMessage({ id: 'sorting' }) : 'Ordenar'}</Subheader>
            <div>
              <IconButton
                style={{ padding: 0 }}
          ...
          <div >
            <div>
              <SelectField
                name='sortField'
                value={sortField}
                hintText={formatMessage ? formatMessage({ id: 'select_field' }) : 'Selecionar coluna'}
          ...
          <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
            <Subheader >{formatMessage ? formatMessage({ id: 'filters' }) : 'Filtros'}</Subheader>
            <div>
              <IconButton
                style={{ padding: 0 }}
                onClick={this.handleAddFilterQuery}
                tooltipPosition={'bottom-left'}
                tooltip={formatMessage ? formatMessage({ id: 'add_filter' }) : 'Add filtro'}>
                <FontIcon
                  className="material-icons"
              ...
              <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }}>
                ...
                <div>
                  <IconButton
                    ...
                    tooltipPosition={'bottom-left'}
                    tooltip={formatMessage ? formatMessage({ id: 'delete_filter' }) : 'Deletar filtro'}>
                    <FontIcon
                      className="material-icons"
